    ...
    <div style={{ fontFamily: 'Kodchasan', marginTop: 50,maxWidth: 1200,marginLeft:'auto',marginRight:'auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <p style={{ textAlign: 'center', }}>An enthusiastic fresher who is highly motivated, eager to learn new things is seeking a
          ...
          skills and my nature to get involved with new people will come in handy.</p></div>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <a style={{textDecoration:'none',}} href="Hukbath Ec.pdf"><button style={{ cursor:'pointer',display: 'block', fontFamily: 'Kodchasan', backgroundColor: '#FCAB2B', color: '#fff', borderRadius: 5, border: 'none', padding: 7, paddingLeft: 25, paddingRight: 25, fontSize: '1.5rem', marginTop: 15, }}>
